...
\begin{frame}{Overview}{Data Science (I)}
	\begin{figure}
		\includegraphics[scale=0.35]{figs/Data_Science_VD.png}	
	\end{figure}				
\end{frame}

\begin{frame}{Overview}{Data Science (II)}
	\begin{figure}
...
\begin{frame}{Data Science}{Anaconda}
    \begin{columns}
 	   \column{.6\textwidth}
   All those tools are packaged in \textit{Anaconda}
   \begin{itemize}
...
\subsection{Conda}
\begin{frame}{Data Science}{Conda crush introduction}
    \begin{columns}
 	   \column{.5\textwidth}
