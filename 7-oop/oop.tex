...
\begin{frame}{Programming paradigms types (IV)}{Classification}
    ...
    ;
        ...
        \node[below of=functional] {\textit{Lisp, Haskell}};
...
\begin{frame}{Inheritance}{Examples of simple inheritance (V)}
    ...
    \umlclass{Weapon}
        ...
        {+ describe() : void\\ + draw() : void\\ + use(): void}
...
\begin{frame}{Concepts of OOP}{Encapsulation (II)}
	...
	\begin{itemize}
		...
		\item \textbf{private}: visible for the class 
            \begin{itemize}
               \item By convenion in Python, start with underscore
...
\begin{frame}{Concepts of OOP}{Encapsulation: The ``pythonic'' way}
    getters and setters comes with some drawbacks
    \begin{itemize}
	...
	\begin{itemize}
		\item It is a \alert{decorator} that transform methods into getters or setters
...
\begin{frame}[plain]%{Characteristics}{Examples of simple inheritance (III)}
	\begin{exampleblock}{}
	\vspace{-0.3cm} 
		\lstinputlisting[basicstyle=\ttfamily\scriptsize]{code/access-pythonic.py}
	\end{exampleblock}
\end{frame}



% TODO: Explicar el estilo pythoniso con propiedades
%\begin{frame}[plain]{Concepts of OOP}{Encapsulation: The pythonic way}
%    The pythonic way is to use properties
%	\begin{exampleblock}{}
%	\vspace{-0.3cm} 
%		\lstinputlisting[basicstyle=\ttfamily\scriptsize]{code/access-pythonic.py}
%	\end{exampleblock}
...
In addition to special method \texttt{\_\_init\_\_}, there are several others, including:\\
	...
	\begin{exampleblock}{}
	\vspace{-0.3cm} 
		\lstinputlisting[basicstyle=\ttfamily\scriptsize]{code/dog-str.py}
	\end{exampleblock}
\end{frame}
...
\begin{frame}[plain]
	\begin{exampleblock}{}
		\vspace{-0.2cm}
		\lstinputlisting[numbers=left]{code/arcade-1.py}
		\vspace{-0.2cm}
	\end{exampleblock}
\end{frame}
