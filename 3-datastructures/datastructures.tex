...
\begin{frame}[plain]{}
	\begin{block}{Objectives}
        ...
        \IfStrEq{\modo}{videojuegos}{
            \item Understand the role of lists in Arcade.
            \item Basic usage of sprites in Arcade.
        } {
...
\subsection{Array}
\begin{frame}[fragile]{Data structures}{Array}
    \begin{columns}
 	   \column{.50\textwidth}
		\begin{center}
		Vector (1-D array)
		...
		nodes={draw}]
{
 ...
 \tiny{2} & $a_{2,0}$ & $a_{2,1}$ & $a_{2,2}$ & $a_{2,3}$\\
		...
		\begin{itemize}
			\item Fixed size
            \item Not supported in Python \textit{by default}
		        \begin{itemize}
			    \item \texttt{NumPy}
		        \end{itemize}
		\end{itemize}
...
\section{Data structures in Arcade}
\subsection{Sprites}
...
\begin{frame}{Data structures in Arcade}{Sprites in Arcade (V)}
    Functional example in \href{https://gist.github.com/dfbarrero/83294a5ea218ca866b68558d4d64ba46}{(example)}
\end{frame}

\begin{frame}{Data structures in Arcade}{Sprites in Arcade (VI)}
