...
It is possible to modify the \textit{global object} within a function?
    ...
    \column{.5\textwidth}
		\begin{block}{Example 1}
		\vspace{-0.2cm}
		\lstinputlisting{code/globalvariables-write1.py}
		\vspace{-0.2cm}
		\end{block}
	\column{.5\textwidth}
		...
		\begin{block}{Example 2}
		\vspace{-0.2cm}
		\lstinputlisting{code/globalvariables-write2.py}
		\vspace{-0.2cm}
		\end{block}
	\end{columns}
\end{frame}
...
\vspace{-0.2cm}
    ...
    \column{.8\textwidth}
		...
		\vspace{-0.4cm}
		\lstinputlisting{code/globalvariables-writeglobal.py}
		\vspace{-0.4cm}
		\end{block}
	\end{columns}
